...
//Verify every field is filled before submitting
    ...
    function submitToDatabase($submitFirstName, $submitLastName, $submitEmail) {
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            echo '<div class="alert alert-success">Booking Success! Refrence ID: <strong>V';
            echo $last_id;
            echo '</strong></div>';
        } else {
...
<div class="container">
    <div class="jumbotron">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class="form-group">
                <label>Ticket price: $900 HKD</label>
            </div>
